...
pub unsafe fn dot_similarity_avx512f(
    ...
    std::arch::asm!(
        ...
        "vmovups zmm4, [{pointer1}]",
        "vfmadd231ps zmm0, zmm4, [{pointer2}]",
        "vmovups zmm5, [{pointer1} + 64]",
        "vfmadd231ps zmm1, zmm5, [{pointer2} + 64]",
        "vmovups zmm6, [{pointer1} + 128]",
        "vfmadd231ps zmm2, zmm6, [{pointer2} + 128]",
        "vmovups zmm7, [{pointer1} + 192]",
        "vfmadd231ps zmm3, zmm7, [{pointer2} + 192]",
